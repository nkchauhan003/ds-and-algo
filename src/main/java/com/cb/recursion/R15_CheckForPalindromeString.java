...
public class R15_CheckForPalindromeString {
    ...
    public static void main(String[] args) {
        ...
        String s3 = "xyz";
        System.out.println(isPalindrome(s3, 0, s3.length() - 1)); // false

        String s4 = "aba";
        System.out.println(isPalindrome(s4, 0, s1.length() - 1)); // true

        String s5 = "abcdcba";
        System.out.println(isPalindrome(s5, 0, s5.length() - 1)); // true
    }
}
